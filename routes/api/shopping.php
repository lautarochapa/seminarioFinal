...
Route::post('family-groups/{id}/shopping-lists/{listId}/process-pending-stock',        [\App\Http\Controllers\Api\V1\ShoppingListCompletion\ShoppingListCompletionController::class, 'processPendingStock']);
