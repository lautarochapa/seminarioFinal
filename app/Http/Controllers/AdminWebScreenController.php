...
class AdminWebScreenController extends Controller
{
    ...
    private function screens()
    {
        return [
            ...
            'meal-types' => ['title' => 'Tipos de comida', 'module' => 'Planificacion', 'description' => 'ABM desayuno, almuerzo, cena y colaciones.', 'primary' => 'Nuevo tipo', 'secondary' => 'Ver catalogo', 'metrics' => [], 'panels' => ['Tipos', 'Orden', 'Catalogo', 'Estado'], 'permission' => 'catalog.manage'],
