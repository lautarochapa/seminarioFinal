...
namespace App\Exceptions\RecipeNutrition;

use RuntimeException;

class RecipeNutritionException extends RuntimeException
{
    ...
    {
        return new self('RECIPE_NUTRITION_FORBIDDEN', 'Sin permiso para esta accion.', 403);
    }
}
