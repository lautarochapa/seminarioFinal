...
{
    protected $fillable = ['shopping_list_id', 'ingredient_id', 'product_id', 'selected_supermarket_product_id', 'quantity', 'unit_id', 'estimated_price', 'actual_price', 'status', 'notes'];

    protected $casts = ['quantity' => 'decimal:4', 'estimated_price' => 'decimal:2', 'actual_price' => 'decimal:2'];
