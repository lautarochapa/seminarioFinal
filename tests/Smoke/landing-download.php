...
$url = 'https://github.com/lautarochapa/seminarioFinal/releases/download/android-v1.0.9-10/CocinaComidaControl-1.0.9-10.apk';
...
checkLanding(strpos($html, 'Descargar APK 1.0.9') !== false, 'Falta version en el boton.');
checkLanding(config('mobile.android.build') === 10, 'Compilacion incorrecta.');
checkLanding(config('mobile.android.size_bytes') === 128750647, 'Tamano de APK incorrecto.');
checkLanding(config('mobile.android.sha256') === 'aacafbad722858f708f146bb82d70c02aa6822aa5c01271e9da20c9a292b9cc9', 'Huella de APK incorrecta.');
