...
$url = 'https://github.com/lautarochapa/seminarioFinal/releases/download/android-v1.0.8-9/CocinaComidaControl-1.0.8-9.apk';
...
checkLanding(strpos($html, 'Descargar APK 1.0.8') !== false, 'Falta version en el boton.');
checkLanding(config('mobile.android.build') === 9, 'Compilacion incorrecta.');
checkLanding(config('mobile.android.size_bytes') === 128749779, 'Tamano de APK incorrecto.');
checkLanding(config('mobile.android.sha256') === '361db97d6bf2be54143aca0f44bd0cb60577044433f1ee40588347a5388d56e3', 'Huella de APK incorrecta.');
