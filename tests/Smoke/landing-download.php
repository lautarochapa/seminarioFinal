...
$url = 'https://github.com/lautarochapa/seminarioFinal/releases/download/android-v1.0.7-8/CocinaComidaControl-1.0.7-8.apk';
...
checkLanding(strpos($html, 'Descargar APK 1.0.7') !== false, 'Falta version en el boton.');
checkLanding(config('mobile.android.build') === 8, 'Compilacion incorrecta.');
checkLanding(config('mobile.android.size_bytes') === 129114783, 'Tamano de APK incorrecto.');
checkLanding(config('mobile.android.sha256') === '5d29dbba7d6756bafac4fdca8fd7d5d71903ba1de140ce0dadbed0f27edda585', 'Huella de APK incorrecta.');
