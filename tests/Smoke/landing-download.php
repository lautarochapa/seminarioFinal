...
$url = 'https://github.com/lautarochapa/seminarioFinal/releases/download/android-v1.0.5-6/CocinaComidaControl-1.0.5-6.apk';
...
checkLanding(strpos($html, 'Descargar APK 1.0.5') !== false, 'Falta version en el boton.');
checkLanding(config('mobile.android.build') === 6, 'Compilacion incorrecta.');
checkLanding(config('mobile.android.size_bytes') === 129076999, 'Tamano de APK incorrecto.');
checkLanding(config('mobile.android.sha256') === '16e0199f303d9f5a9dfddd65a1df11481483fa3d0169a818dbc3a4faedaeda94', 'Huella de APK incorrecta.');
